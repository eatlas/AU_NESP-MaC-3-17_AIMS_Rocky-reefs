...
MODEL_DIR = r'working/training-data-texture'
...
def main():
    ...
    tx_true_color_feature_cols = ['S2_TX_B2', 'S2_TX_B3', 'S2_TX_B4']
    all_feature_cols = lt_false_color_feature_cols + lt_true_color_feature_cols + at_true_color_feature_cols + tx_true_color_feature_cols
