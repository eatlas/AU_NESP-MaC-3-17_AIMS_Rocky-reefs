...
MULTI_SHAPEFILE_DIR = 'working/06-multi'
BINARY_SHAPEFILE_DIR = 'working/06-binary'
...
MULTI_MODEL_PATH = 'working/training-data/random_forest_model_multiclass.pkl'
MULTI_ENCODER_PATH = 'working/training-data/classes_mapping_multiclass.pkl'

# This is for the binary-class classifier model option
BINARY_MODEL_PATH = 'working/training-data/random_forest_model_binary.pkl'
BINARY_ENCODER_PATH = 'working/training-data/classes_mapping_binary.pkl'
...
def main():
    ...
    if args.binary_classifier:
        shapefile_dir = BINARY_SHAPEFILE_DIR
    else:
        shapefile_dir = MULTI_SHAPEFILE_DIR
    ...
    if args.binary_classifier:
        ...
        encoder_path = BINARY_ENCODER_PATH
    else:  
        model_path = MULTI_MODEL_PATH
        encoder_path = MULTI_ENCODER_PATH
