...
if [ ! -f "$FLAG_FILE" ]; then
    ...
    python 01a-download-sentinel2.py --dataset 15th_percentile --region NorthernAU --output ~/AU_AIMS_S2-comp
    python 01a-download-sentinel2.py --dataset 15th_percentile --region GBR --output ~/AU_AIMS_S2-comp
